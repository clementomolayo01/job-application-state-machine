import { Controller, Patch, Param, Body, Get, UseGuards, Req, Post } from '@nestjs/common';
...
export class ApplicationsController {
  ...
  @ApiHeader({ name: 'x-user-role', required: true, description: 'Role of the user (ADMIN, COMPANY, CANDIDATE)' })
  @ApiHeader({ name: 'x-user-id', required: true, description: 'ID of the user' })
